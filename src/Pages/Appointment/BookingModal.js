...
<div className="modal modal-bottom sm:modal-middle">
    ...
    <form onSubmit={handleBooking} className='grid grid-cols-1 gap-3 justify-items-center my-3'>
    ...
    <input type="email" disabled value={user?.email || ''} placeholder="Email Address" className="input input-bordered w-full max-w-xs" />
